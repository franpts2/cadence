<script lang="ts">
	...
	let { imageUrl, albumName } = $props<{
		imageUrl: string | undefined;
		albumName: string;
	}>();
</script>

<div class="relative w-full aspect-square mb-6 rounded-xl overflow-hidden shadow-lg border border-border/20 group cursor-pointer">
	{#if imageUrl}
		<img
			src={imageUrl}
			alt={albumName}
